...
from haruka import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_USERNAME, \
    ALLOW_EXCL
...
DEFAULTUSER = str(OWNER_USERNAME) if OWNER_USERNAME else "NO SET"
